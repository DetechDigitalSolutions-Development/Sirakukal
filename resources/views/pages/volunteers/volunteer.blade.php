...
@section('content')
    ...
    <section class="py-20 bg-white">
        <div class="container mx-auto px-8">
            <div class="text-center mb-12">
                <h2 class="text-3xl font-bold">Benefits of Volunteering</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
                ...
                <div class="text-center p-6 bg-white rounded-lg shadow-sm border border-gray-100">
                    <div class="text-flame-red mb-4 flex justify-center">
                    ...
                    <p class="text-gray-600 text-sm">Gain practical experience and learn valuable skills applicable to various careers.</p>
                </div>
                ...
                <div class="text-center p-6 bg-white rounded-lg shadow-sm border border-gray-100">
                    ...
                    <p class="text-gray-600 text-sm">Make a tangible difference in the lives of others and contribute to local initiatives.</p>
                </div>
                ...
                <div class="text-center p-6 bg-white rounded-lg shadow-sm border border-gray-100">
                    ...
                    <p class="text-gray-600 text-sm">Connect with like-minded individuals, community leaders, and potential employers.</p>
                </div>
                ...
                <div class="text-center p-6 bg-white rounded-lg shadow-sm border border-gray-100">
                    ...
                    <p class="text-gray-600 text-sm">Boost your confidence, empathy, and leadership abilities through meaningful experiences.</p>
                </div>
                ...
                <div class="text-center p-6 bg-white rounded-lg shadow-sm border border-gray-100">
                    ...
                    <h3 class="text-xl font-bold mb-2">Sense of Purpose</h3>
                    <p class="text-gray-600 text-sm">Find fulfillment and meaning by contributing to causes you care about.</p>
                </div>
                ...
                <div class="text-center p-6 bg-white rounded-lg shadow-sm border border-gray-100">
                    ...
                    <h3 class="text-xl font-bold mb-2">Cultural Immersion</h3>
                    <p class="text-gray-600 text-sm">Experience diverse cultures and gain a broader perspective on global issues.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="volunteer-form" class="py-20 bg-gray-50">
        <div class="container mx-auto px-8">
            <div class="text-center mb-12">
                <h2 class="text-3xl font-bold">Become a Volunteer</h2>
                <div class="h-1 w-20 bg-primary rounded mx-auto mt-4"></div>
                <p class="text-gray-600 mt-4 max-w-2xl mx-auto">Fill out the form below to become a volunteer.</p>
            </div>
