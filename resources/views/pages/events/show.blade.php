...
@section('content')
    ...
    <section class="py-10 md:py-16 bg-gray-50">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="mb-8">
                <a href="{{ route('events.index') }}" class="inline-flex items-center text-gray-600 hover:text-primary transition-colors">
                ...
                <div class="md:flex">
                    ...
                    <div class="md:w-3/5 p-6 md:p-8">
                        <div class="flex items-center justify-between mb-4">
                            <span class="bg-primary text-white text-xs font-bold px-3 py-1.5 rounded-full">
                                {{ $event->type ?? 'Event' }}
                            </span>
                        ...
                        <h1 class="text-3xl font-bold mb-4">{{ $event->name ?? 'Event Title' }}</h1>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p class="font-medium">{{ $event->time ?? '10:00 AM - 3:00 PM' }}</p>
                                    </div>
                                </div>
                    ...
                    <div class="bg-white rounded-lg shadow-md p-6">
                        ...
                        <form>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="email" id="email" name="email" class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-primary" required>
                            </div>
                            
                            <div class="mb-4">
                                <label for="phone" class="block text-sm font-medium text-gray-700 mb-1">Phone Number</label>
                                <input type="tel" id="phone" name="phone" class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-primary" required>
                            </div>
                            
                            <div class="mb-6">
                                <label for="message" class="block text-sm font-medium text-gray-700 mb-1">Additional Information</label>
                                <textarea id="message" name="message" rows="3" class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-primary"></textarea>
                        ...
                        <div class="mt-8 pt-6 border-t border-gray-200">
                            <h4 class="font-medium mb-3">Questions about this event?</h4>
                            <p class="text-sm text-gray-600 mb-2">Contact the organizer directly:</p>
                            <div class="text-sm">
                                <p class="mb-1">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                @foreach($relatedEvents as $relatedEvent)
                    <div class="relative">
                        ...
                        <div class="absolute top-4 right-4 bg-primary text-white text-xs font-bold px-2 py-1 rounded">{{ $relatedEvent->type }}</div>
                    </div>
                @endforeach
            </div>
        @else
